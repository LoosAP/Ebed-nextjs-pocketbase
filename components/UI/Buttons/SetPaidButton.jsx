...
const SetPaidButton = ({ selected, onPaid, getTotalPrice, className }) => {
      ...
      {isOpen && (
        <div className="fixed top-0 left-0 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
          <div className="p-4 text-center bg-white rounded shadow-lg">
            <h2 className="mb-2 text-lg font-bold">Fizetés megerősítése</h2>
            <p className="mb-4">
              Biztos benne, hogy ki akarja jelölni a kiválasztott elemeket
              fizetettként?
            </p>
            <p className="mb-4">Összesen: {getTotalPrice()} Ft</p>
